...
export default function Home() {
  return (
    ...
    <section className="bg-white min-h-screen py-20 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-5 flex flex-col justify-start">
            
            {/* Teks "CREATIVE MARKETING" yang Bertumpuk/Berbayang */}
            <div className="mb-8">
              <p className="text-4xl sm:text-5xl lg:text-6xl font-extrabold opacity-30 text-yellow-500 tracking-tight leading-none relative -translate-x-1 -translate-y-1">
                CREATIVE MARKETING
              </p>
              <p className="text-4xl sm:text-5xl lg:text-6xl font-extrabold opacity-50 text-blue-500 tracking-tight leading-none relative -translate-x-1 -translate-y-1">
                CREATIVE MARKETING
              </p>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-black tracking-tight leading-none relative">
                CREATIVE MARKETING
              </h1>
            </div>

            {/* Subteks/Deskripsi */}
            <p className="text-sm md:text-base text-gray-700 max-w-sm mb-10">
            ...
            <div className="flex items-baseline mb-16">
              ...
              <span className="text-2xl sm:text-3xl font-bold text-white bg-black px-3 py-1 tracking-wider">
                + MARKETING CHANNELS
              </span>
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-7 relative flex flex-col items-end">
            
            {/* Gambar Kecil Kiri Atas (Menggunakan posisi absolut untuk penempatan yang meniru tata letak) */}
            {/* Dalam implementasi nyata, ini mungkin gambar latar depan yang dikrop. */}
            <div className="absolute top-0 left-0 w-28 h-16 sm:w-40 sm:h-24 md:w-48 md:h-28 bg-gray-200 z-10 overflow-hidden border border-gray-300 shadow-lg">
                <Image
                    src="/cards/card3.png" // Ganti dengan path gambar yang sebenarnya
            ...
            {/* Gambar Utama (Dua Wajah) - Menempati sebagian besar ruang kolom kanan */}
            <div className="w-full h-64 sm:h-80 md:h-96 lg:h-[30rem] bg-gray-300 relative z-0 overflow-hidden shadow-xl">
              <Image
                src="/cards/card2.png" // Ganti dengan path gambar yang sebenarnya
                alt="Close-up of a man and woman with serious expressions, vibrant background"
                layout="fill"
                objectFit="cover"
                priority
              />
            ...
            {/* Gambar Kecil Kanan Bawah (Tangan dengan Gelang) - Menggunakan posisi relatif/grid untuk menggeser ke bawah kanan */}
            <div className="w-40 h-28 sm:w-56 sm:h-36 md:w-64 md:h-40 bg-gray-400 absolute bottom-[-4rem] right-0 md:bottom-[-6rem] md:right-[-2rem] z-10 overflow-hidden shadow-xl border border-gray-300">
              <Image
                src="/cards/card3.png" // Ganti dengan path gambar yang sebenarnya
                alt="Hand with bracelet and nail polish resting on a reflective surface"
                layout="fill"
                objectFit="cover"
              />
            </div>
      ...
      {/* Spacer untuk mengkompensasi gambar yang keluar dari batas bawah */}
    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        
        {/* Baris Atas: Logo, Navigasi, dan Ikon Sosial */}
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start mb-8">
          ...
          <div className="flex flex-col items-center md:items-start mb-8 md:mb-0">
            ...
            <div className="w-32 h-12 relative mb-2">
              {/* Ini adalah placeholder. Ganti dengan logo SVG atau PNG asli Anda */}
              {/* <Image src="/logo.png" alt="Revemoin Logo" layout="fill" objectFit="contain" /> */}
